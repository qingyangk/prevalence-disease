...
export default {
  ...
  data() {
    return {
      ...
      url: 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/map/MapServer/2',
      url12: 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/map/MapServer/2',
      // 查询底图
