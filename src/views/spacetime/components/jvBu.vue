...
export default {
  ...
  data() {
    return {
      ...
      url: 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/Localmoran/MapServer/1',
      url12: 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/Localmoran/MapServer/1',
      // 查询底图
